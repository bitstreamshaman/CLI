...
class SessionManager:
    ...
    def get_context(self) -> Dict[str, str]:
        ...
        try:
            ...
            context = {"username": username, "hostname": hostname, "cwd": cwd}
            ...
            self.console.print(
                f"[yellow]Warning: Could not get system context: {e}[/yellow]"
            )
            fallback_context = {"username": "user", "hostname": "localhost", "cwd": "~"}
