...
class CommandProcessor:
        ...
        try:
            ...
            for handler in self.handlers:
                try:
                    ...
                    self.console.print(f"[yellow]⚠️  Error checking handler {handler.__class__.__name__}: {e}[/yellow]")
                    continue
    ...
    def get_processing_stats(self) -> dict:
        ...
        return {
            ...
            'success_rate': (self.successful_commands / max(1, self.commands_processed)) * 100,
    ...
    def __repr__(self) -> str:
        ...
        return (f"CommandProcessor(handlers={len(self.handlers)}, "
